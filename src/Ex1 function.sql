...
END
Это функция, которую я запихнула в комментарии потому что она не выгружается в файл иначе. Так что ее надо положить в функции и тогда через селект все отлично работает. В скобочках в селекте вписывается нужное число */
